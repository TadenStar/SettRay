...
class BlenderRenderGUI:
    ...
    def _build_main_screen(self):
        ...
        title_canvas = tk.Canvas(self.content, width=200, height=40, bg=THEME_BG, highlightthickness=0, bd=0)
        title_canvas.pack(pady=(0, 20))
        title_canvas.create_text(103, 23, text="SETTRAY", font=("Calibri", 18, "bold"), fill="#808080")
        title_canvas.create_text(100, 20, text="SETTRAY", font=("Calibri", 18, "bold"), fill=THEME_ACCENT)
        ...
        tk.Button(self.footer, text="Settings", command=self.show_settings_screen, bg=THEME_BUTTON, fg="white", font=("Calibri", 8)).place(x=10, y=36)
